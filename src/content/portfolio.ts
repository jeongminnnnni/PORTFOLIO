...
/** 헤더 내비. sections: 스크롤 스파이에서 이 항목을 활성화할 섹션 id 목록 */
export const nav = [
  {
    id: "about",
    label: "About",
...
export const projects: Project[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        body: [
          ...
          "인라인 출처칩 + 근거카드 UX: 생성 후처리로 출처를 노출해 LLM 토큰 추가 없이 근거를 전달합니다.",
        ],
      },
      {
        label: "검증",
        body: ["회귀 검증 21건 통과로 기존 답변 품질이 유지됨을 확인했습니다."],
      },
      {
        label: "기대 효과",
        body: ["월 4시간 절감, 클레임 20% 감소"],
      },
    ],
  ...
  },
  {
    ...
    meta: "2인 팀 · 시스템 설계 · SFT · Guardrail",
    summary:
    ...
    blocks: [
      ...
      },
      {
        label: "검증",
        body: [
          "원가 근접율 7.5% → 35% (SFT 기여)",
          "마진 위반율 0% (Guardrail 구조)",
        ],
      },
    ],
    ...
    blocks: [
      {
        label: "문제",
        body: [
          "개별 불만은 제각각이었지만 하나의 순환 구조로 정리되었습니다. 기술 오작동이 구식 디자인 인상을 만들고, 관리자는 갱신 의욕을 잃고, 사용자는 방문하지 않습니다.",
        ],
      },
      {
        label: "구조 설계",
  ...
  },
  {
    id: "eogiya",
    title: "어기야팩토리 거래량 예측",
    meta: "거래량 데이터 분석 · 시계열 예측 방법론 비교",
    summary:
      "Naive 베이스라인부터 통계·ML 모델까지 동일 조건에서 비교해, 이 데이터로 예측이 성립하는 해상도와 대상을 먼저 특정한 분석 프로젝트",
    role: "방법론 비교 실험 설계와 결과 보고를 담당했습니다.",
    blocks: [
      {
        label: "접근",
        body: [
          "가장 단순한 Naive 모델을 기준선으로 두고 통계·ML 모델을 같은 조건에서 비교했습니다.",
        ],
      },
      {
        label: "결론",
        body: [
          "가장 단순한 모델이 가장 정확했다는 결과를 그대로 보고했습니다. 정확도를 높이기 전에, 이 데이터로 예측이 성립하는 해상도와 대상이 어디까지인지 먼저 특정하는 것이 우선이라는 판단으로 이어졌습니다.",
        ],
      },
    ],
    stack: ["Python", "시계열 예측"],
...
export const sideProjects: SideProject[] = [
  ...
  },
  {
    ...
    meta: "콜드메일 캠페인",
    body: "100여 곳 후보 중 제품이 실제로 해결하는 문제를 가진 5곳만 남겨 정밀 타겟팅했습니다. '왜 5곳인가'를 기준으로 후보를 좁힌 판단 과정이 핵심입니다.",
  },
  {
    title: "BarKit",
    meta: "Frontend Lead",
